...
const DRIP_EMAIL_SEED = [
  ...
  { seq: 12, subject: "A free trial that's actually free.", body: `No credit card required. No hidden fees. Just 7 full days of access to everything Masakhe offers. If you love it, upgrade later. If not, walk away.\n\nStart your risk-free trial today.\n👉 www.masakheportal.co.za/register` },
  { seq: 13, subject: "Your 7-day roadmap to a smoother business.", body: `Day 1: Build your AI website. Day 2: Send an invoice. Day 3: Schedule social posts. By day 7, you'll wonder how you managed without Masakhe.\n\nGet the full roadmap – start free.\n👉 Register at www.masakheportal.co.za/register` },
  { seq: 14, subject: "Stop juggling. Start managing.", body: `When your clients, finances, and team are all in one place, running your business becomes calm and clear. Masakhe brings order to the chaos.\n\nExperience control free for 7 days.\n👉 Claim your trial at www.masakheportal.co.za/register` },
  ...
  { seq: 20, subject: "Don't let another week slip away.", body: `Every day you wait is another day of juggling spreadsheets, missed social posts, and late invoices. Your 7-day free trial is ready – click below to claim it.\n\n👉 Start your free trial now at www.masakheportal.co.za/register` },
];
