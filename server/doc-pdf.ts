...
async function buildBusinessPlanPdf(doc: any, user: any): Promise<Uint8Array> {
  ...
  cover.drawText("Generated by Masakhe SMME Growth Hub  ·  masakhegroup.co.za", { x: ML, y: 35, size: 7.5, font, color: rgb(0.7, 0.7, 0.7) });
...
async function buildFundingApplicationPdf(doc: any, user: any): Promise<Uint8Array> {
  ...
  cover.drawText("Generated by Masakhe SMME Growth Hub  ·  masakhegroup.co.za", { x: ML, y: 44, size: 7.5, font, color: rgb(0.7, 0.7, 0.7) });
