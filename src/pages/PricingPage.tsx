...
const MODULES = [
  {
    ...
    iconBg: "bg-sky-500",
    features: [
      "Create and manage a professional online presence",
  ...
  },
  {
    ...
    features: [
      "Draft platform-ready posts faster with AI support",
      "Publish polished updates for professional visibility",
      "Facebook, Instagram & LinkedIn scheduling",
  ...
  },
  {
    ...
    features: [
      "Track cash flow and keep finances organized",
      "Send quotes, create invoices, and follow up with ease",
      "Keep customer records, communication, and updates in one place",
      "Monitor stock levels and reduce supply gaps",
      "Run campaigns and automate recurring tasks",
      "Up to 4 user accounts",
    ],
  },
  {
    ...
    iconBg: "bg-amber-500",
    features: [
      "Manage team records, payroll, and people operations",
