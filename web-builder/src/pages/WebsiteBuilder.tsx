...
export default function WebsiteBuilder() {
  ...
  const [isProPlan] = useState(true); // all templates unlocked in standalone
    ...
    return (
      <div className="flex h-full flex-col overflow-hidden bg-slate-100">
        <div className="flex items-center justify-between px-4 py-3 border-b bg-gradient-to-r from-amber-500 to-amber-600 text-white shadow-md">
          ...
          <div className="flex items-center gap-2">
            <Button size="sm" className="h-8 text-xs bg-white text-amber-600 hover:bg-white/90 font-bold" onClick={() => { window.location.href = "/"; }}>
